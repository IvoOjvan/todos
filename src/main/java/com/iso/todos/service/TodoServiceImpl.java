...
import com.iso.todos.entity.Todo;
import com.iso.todos.entity.User;
import com.iso.todos.repository.TodoRepository;
...
public class TodoServiceImpl implements TodoService{
    ...
    public List<TodoResponse> getAllTodos() {
        User currentUser = findAuthenticatedUser.getAutheticatedUser();
    ...
    public TodoResponse toggleTodoCompletion(long id) {
        ...
        boolean isTodoComplete = todo.get().isComplete();
        todo.get().setComplete(!isTodoComplete);
